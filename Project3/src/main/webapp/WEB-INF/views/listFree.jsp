		...
		<c:if test="${not empty pv.list }">
			...
			<c:forEach var="vo" items="${pv.list }" varStatus="vs">
				<tr align="center">
					...
					<td align="left" >
						<a href="#" onclick='SendPost("${pageContext.request.contextPath }/board/viewFree",{"p":${pv.currentPage },"s":${pv.pageSize },"b":${pv.blockSize },"idx":${vo.idx },"m":"view","h":"true"},"post")'>
							<c:out value="${vo.subject }"></c:out>
						</a>
						<%-- 댓글의 개수를 출력해 주자 --%>
						<c:if test="${vo.freeCommentCount>0 }">
							- [${vo.freeCommentCount }]
						</c:if>
		...
		<tr>
			<td class="info" colspan="5">
				<button type="button" class="btn btn-success btn-sm" 
			        onclick='SendPost("${pageContext.request.contextPath }/board/insertFree",{"p":${pv.currentPage },"s":${pv.pageSize },"b":${pv.blockSize }},"post")'>글쓰기</button>

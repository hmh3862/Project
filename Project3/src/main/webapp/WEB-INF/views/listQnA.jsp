				...
				<script type="text/javascript">
					$(function(){
						$("#listCount").change(function(){
							...
							SendPost("${pageContext.request.contextPath }/board/listQnA", {"p":${cv.currentPage},"s":pageSize,"b":${cv.blockSize}});
						});	
					});
				</script>
				<select id="listCount">
		...
		<c:if test="${not empty pv.list }">
			<c:forEach var="vo" items="${pv.list }" varStatus="vs">
				<tr align="center">
					<td>${vo.idx }</td>
					<td align="left" >
						<a href="#" onclick='SendPost("${pageContext.request.contextPath }/board/viewQnA",{"p":${pv.currentPage },"s":${pv.pageSize },"b":${pv.blockSize },"idx":${vo.idx },"m":"view","h":"true"},"post")'><c:out value="${vo.subject }"></c:out></a>
